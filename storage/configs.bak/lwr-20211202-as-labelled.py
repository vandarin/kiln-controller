...
# Event hooks - set system commands to run when a profile is started or stopped
hook_run_profile = "DISPLAY=:0 xset dpms force on && xset -dpms"
hook_reset = "DISPLAY=:0 xset +dpms"
